...
text = """
Reading is essential for learning and personal growth. It exposes us to new ideas and perspectives, helps us to develop our critical thinking skills, and expands our vocabulary. Reading can also be a great source of entertainment and relaxation.

There are many different types of reading material available, so there is something for everyone. Whether you enjoy fiction, non-fiction, poetry, or magazines, there is a book out there that can enrich your life.

In today's digital age, it is more important than ever to be able to read effectively. The ability to read and understand complex information is essential for success in school, work, and life.

"""

sum = bertSummarize(text)
print(sum)